<div class="dokan-product-inventory dokan-edit-row <?php echo esc_attr($class); ?>">
    ...
    <div class="dokan-section-content">
        ...
        <div class="content-half-part dokan-form-group">
            <label for="_sku" class="form-label"><?php esc_html_e('SKU', 'dokan-lite'); ?> </label>
        ...
        <?php if ('yes' === get_option('woocommerce_manage_stock')) : ?>
            <div class="dokan-form-group hidden hide_if_grouped hide_if_external">
                <div class="dokan-form-group hidden">
                    <?php dokan_post_input_box($post_id, '_manage_stock', array('label' => __('Enable product stock management', 'dokan-lite'), 'value' => yes), 'checkbox'); ?>
                </div>
            </div>
